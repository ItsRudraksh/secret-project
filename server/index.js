...
//         console.log("Server is bieng hit and kept running");
//         if (counter < 3) {
...
//     console.log("Birthday prep email sent successfully at 12:00 AM!");
//   } catch (error) {
...
// Schedule the cron job at 13-minute intervals with the IST time zone
cron.schedule(
  "*/13 * * * *",
  () => {
    console.log("Hitting server");
